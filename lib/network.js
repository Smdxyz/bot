        ...
        try {
            ...
            return await this.client.post(url, {
                ...
                headers: {
                    ...
                    'Origin': origin, // Set Origin dynamically
                    'Referer': `${origin}/`, // Use a generic but valid default Referer
                    ...customHeaders // Allow customHeaders (like a more specific Referer) to override defaults
                }
            });
        } catch (error) {
